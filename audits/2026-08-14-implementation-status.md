...
| AskRigor | PR [#7](https://github.com/u-dont-existDOTcom/AskRigor/pull/7), head `1fbfb9c7b67afc5866e55f56de57fdf58508f599` | deterministic run [31849152200](https://github.com/u-dont-existDOTcom/AskRigor/actions/runs/31849152200), job `94921467390`: success; workflow-policy run [31849152180](https://github.com/u-dont-existDOTcom/AskRigor/actions/runs/31849152180), job `94921467289`: success | public rulesets empty; classic protection and security/Actions endpoints inaccessible; private reporting disabled; issue [#6](https://github.com/u-dont-existDOTcom/AskRigor/issues/6) | `BLOCKED` |
| AskRigor-lessons | PR [#3](https://github.com/u-dont-existDOTcom/AskRigor-lessons/pull/3), head `469aa62938a638145b1b848b9199710767e868aa` | `AskRigor lesson integrity` run [31849634303](https://github.com/u-dont-existDOTcom/AskRigor-lessons/actions/runs/31849634303), `Lesson integrity` job `94922840626`: success | private plan-limited rulesets; admin/security endpoints inaccessible; code scanning disabled; issue [#2](https://github.com/u-dont-existDOTcom/AskRigor-lessons/issues/2) | `BLOCKED` |

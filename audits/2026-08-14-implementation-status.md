...
- AskRigor's exact bootstrap/deterministic/site/deployment commands, authority chain, complete-protocol byte/hash behavior, source-access truth states, public MCP boundary, release distinction, and final CI are verified on PR #7. Its opt-in provider smoke was not part of that PR's compliance evidence. A later, separately bounded paid Action acceptance was completed and merged through PR #8; it does not substitute for PR #7's final compliance reconciliation or hosted-control evidence.

...
For conversational reply references such as **“X replied,” “X answered,” “they said back,”** or equivalent, resolve the reply edge before interpreting content. First identify the most recent actual outbound message or question to the named person in the available conversation/history and bind the reply to that chronological antecedent. Explicit recipient identity plus conversational adjacency outrank lexical, emotional, or topical similarity. Use semantic/topic matching only when no chronological antecedent can be recovered. If more than one chronological antecedent remains genuinely plausible, inspect the relevant recent history before interpreting; do not silently choose an older same-person thread because the reply contains words associated with it. A reply may mention “worked,” “crying,” “energy,” or another salient term without changing which message it answers. Exact user-provided reply context or an explicit antecedent named inside the reply overrides chronology.

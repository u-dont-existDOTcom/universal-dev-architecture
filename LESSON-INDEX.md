...
26. `patterns/chat-work-terminal-routing.md` — keep Chat as the owner-facing supervisor, treat actual missing terminal/shell capability rather than repository involvement as the Work-task trigger, delegate one bounded execution packet, retrieve the result, and continue in the originating Chat without making the owner shuttle context.

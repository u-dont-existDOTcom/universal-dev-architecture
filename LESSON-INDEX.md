...
22. `patterns/human-readable-operational-references.md` — explain owner-facing operational objects in plain language before opaque PR, issue, branch, commit, workflow/run/job, artifact, or detector identifiers; reconstruct topology semantically after context loss and state substantive decisions instead of asking the owner to choose among handles.

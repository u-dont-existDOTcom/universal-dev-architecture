...
26. `patterns/chat-work-terminal-routing.md` — keep Chat as the owner-facing supervisor, treat actual missing terminal/shell capability rather than repository involvement as the Work-task trigger, hand Codex a reasoning-complete artifact-bound execution packet, require it to fail closed rather than invent missing semantic inputs or self-certify independent judgment, retrieve the result, and continue in the originating Chat without making the owner shuttle context.

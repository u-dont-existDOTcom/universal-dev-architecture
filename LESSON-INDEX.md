...
19. `patterns/persistent-browser-automation-hygiene.md` — treat persistent browser profiles as authentication/state stores rather than uncontrolled tab archives; normalize/close tabs explicitly, bind asynchronous GUI completion to the exact expected artifact across all pages, and recover ambiguous paid/irreversible actions before any repeat.

...
40. `patterns/mission-control-multi-host-submission-scheduling.md` — keep browser relay hosts active/passive behind one durable submission scheduler; require a single-use admission before every browser send, globally pace crossed boundaries, fence failover epochs, bind sends to Mission Control-only chats and automation-owned targets, and fail closed on partition or ownership ambiguity.

...
- [ ] **Step 2: Add an import/behavior regression**
...
- [ ] **Step 4: Make the minimal regex repair**
...
- [ ] **Step 1: Add profile validation regressions**
...
- [ ] **Step 3: Implement exact profile/evidence validation**
...
- [ ] **Step 4: Add instruction-budget regressions**
...
- [ ] **Step 5: Run instruction tests red, implement, and rerun green**
...
- [ ] **Step 6: Add workflow-security regressions**
...
- [ ] **Step 9: Add unsafe-filename and risk-posture regressions**
...
- [ ] **Step 10: Implement filename/risk checks and run the full suite**
...
- [ ] **Step 1: Make the canonical route unambiguous**
...
- [ ] **Step 2: Preserve the older standard as provenance**
...
- [ ] **Step 3: Reconcile risk-adjusted classifications**
...
- [ ] **Step 4: Refresh the official source registry**
...
- [ ] **Step 5: Record exact hosted-control evidence**
...
- [ ] **Step 6: Add the private high-risk security posture**
...
- [ ] **Step 7: Reconcile active plans and ledgers**
...
- [ ] **Step 1: Add the generic repository worker template**
...
- [ ] **Step 2: Add the final fleet auditor template**
...
- [ ] **Step 3: Add mandate-generation guidance and metadata**
...
- [ ] **Step 4: Complete semantic lesson closeout**
...
- [ ] **Step 5: Validate JSON and run all deterministic gates**
...
- [ ] **Step 1: Consolidate ordinary CI**
...
- [ ] **Step 2: Remove the obsolete duplicate workflow**
...
- [ ] **Step 3: Make weekly drift reporting idempotent**
...
- [ ] **Step 4: Validate workflow policy behavior**
...
- [ ] **Step 5: Update PR evidence requirements**
...
- [ ] **Step 5: Apply/verify safe governance or create one blocker issue**

...
- `CLAIM-TRANSITION-REGISTRY.json` — relying-party-supplied immutable transition history with whole-ledger digest, trusted head, exact predecessor membership, and claim-ref continuity.
...
- `REPRODUCTION-INDEPENDENCE-REGISTRY.json` — relying-party admission binding distinct producer/reproducer identities and trust domains, evidence, basis, admission issuer, and immutable digests.
